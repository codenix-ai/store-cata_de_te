...
export function Navbar() {
  ...
  return (
    <nav className="shadow-lg sticky top-0 z-50" style={{ backgroundColor: store.primaryColor }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center">
              {store.logoUrl ? (
                ...
                <span className="text-2xl font-bold font-montserrat" style={{ color: store.textColor }}>
                  {store.name}
                </span>
              )}
            </Link>
