  ...
  const defaultTestimonials = [
    {
      ...
      rating: 5,
      comment:
        "El té verde japonés que compré superó todas mis expectativas. La frescura y el aroma son incomparables.",
    },
    {
      id: "2",
      name: "Carlos Mendoza",
      ...
      rating: 5,
      comment:
        "Como profesional, valoro la consistencia y calidad de las hebras. Sus blends son muy bien logrados.",
    },
    {
      id: "3",
      name: "Ana Martínez",
      ...
      rating: 5,
      comment:
        "Las infusiones herbales son deliciosas y el empaque mantiene todo fresco. Excelente servicio y envío rápido.",
    },
  ];
