          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Define el precio y disponibilidad
              </p>
            </div>
        ...
        return (
          <div className="space-y-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Sube fotos de tu producto y define sus variantes
              </p>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1 text-sm md:text-base">
                  Sigue los pasos para {product ? "actualizar" : "crear"} tu
                  producto
                </p>
              </div>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-1 md:mt-2 text-center flex flex-col items-center w-full">
                    ...
                    <p className="text-xs text-gray-400 mt-1 hidden lg:block truncate max-w-20">
                      {step.description}
                    </p>
                  </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <span className="text-sm text-gray-500">
                {steps.findIndex((s) => s.id === currentStep) + 1} de{" "}
                {steps.length}
              </span>
            </div>
