...
export function VariantCombinationGenerator({
  ...
  const [combinations, setCombinations] =
    useState<VariantCombination[]>(existingCombinations);
        ...
        (existing) =>
          ...
          (existing.variants.length === newCombo.variants.length &&
            existing.variants.every(
              (ev, i) =>
                ev.type === newCombo.variants[i].type &&
                ev.name === newCombo.variants[i].name
            ))
      );
    ...
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <div className="text-center text-gray-500">
          ...
          <p className="text-sm">
            Agrega colores, tallas o variantes personalizadas para generar
            combinaciones
          </p>
        </div>
      </div>
            ...
            <div>
              ...
              <p className="text-sm text-purple-700 mt-1">
                ...
                {Object.keys(customVariantsByType).length > 0 && (
                  <span>
                    {" "}
                    más las combinaciones con las variantes personalizadas
                  </span>
                )}
              </p>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              <div className="flex items-center">
                ...
                <p className="text-sm text-green-800">
                  <strong>Combinaciones existentes cargadas:</strong> Se han
                  cargado {combinations.length} combinaciones con su stock
                  actual.
                </p>
              </div>
            </div>
            ...
            <div className="max-h-96 overflow-y-auto">
              <div className="space-y-0">
                {combinations.map((combination, index) => (
                  <div
                    key={combination.id}
                    className={`flex justify-between px-4 py-4 border-b border-gray-100 last:border-b-0 ${
            ...
            <div className="bg-gray-50 px-4 py-3 border-t border-gray-200">
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">
                  Total de combinaciones: {combinations.length}
                </span>
                <span className="text-gray-600">
                  Stock total:{" "}
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  Puedes establecer diferentes cantidades de stock para cada
                  combinación de variantes. Esto te permitirá tener un control
                  preciso del inventario para cada versión específica de tu
                  producto.
                </p>
              </div>
            </div>
