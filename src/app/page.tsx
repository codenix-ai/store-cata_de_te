...
export default async function HomePage() {
  ...
  const imageA = siteConfig?.gallery?.images?.[0]?.id || "/assets/img2.webp";
  const imageB = siteConfig?.gallery?.images?.[1]?.id || "/assets/img1.webp";
  const imageC = siteConfig?.gallery?.images?.[2]?.id || "/assets/img3.webp";
  const imageD = siteConfig?.gallery?.images?.[3]?.id || "/assets/img4.webp";
  const imageE =
    siteConfig?.gallery?.images?.[4]?.id || "/assets/bannercata.webp";
    ...
    <Layout>
      <div className="space-y-12">
        ...
        <HeroBanner
          ...
          imageE={siteConfig?.hero?.backgroundImage?.id || imageE}
