...
import { User, Mail, Calendar, Shield, Store, MapPin, Edit, Save, X, Camera, Settings } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <a href="/auth/signin" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
            Iniciar Sesión
          </a>
        </div>
      </div>
            ...
            {user.store && (
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <a href="/admin/store" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
                    Gestionar
                  </a>
                </div>
              </div>
