...
const getProductById = (id: string) => {
  const products = {
    '1': {
      ...
      stock: 15,
      variants: [
        { id: 'config1', name: 'Configuración', value: '16GB RAM / 512GB SSD', price: 2500000 },
        { id: 'config2', name: 'Configuración', value: '32GB RAM / 1TB SSD', price: 3200000 },
      ],
    },
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="space-y-2">
                {product.variants.map(variant => (
                  ...
                  >
                    ...
                    <span className="font-medium text-black">${variant.price?.toLocaleString('es-CO')}</span>
                  </label>
                ))}
              </div>
            </div>
      ...
      <div className="border-t pt-8">
        ...
        <div className="py-8">
          ...
          {activeTab === 'reviews' && (
            <div>
              <h3 className="text-lg font-medium text-black mb-4">Reseñas de clientes</h3>
              <p className="text-gray-600">Las reseñas se mostrarán aquí próximamente.</p>
            </div>
          )}
        </div>
      </div>
