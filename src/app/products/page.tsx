    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex justify-center">
        <nav className="flex items-center space-x-2">
          ...
          <button className="px-3 py-2 text-gray-700 hover:text-black rounded-md hover:bg-gray-100">2</button>
          <button className="px-3 py-2 text-gray-700 hover:text-black rounded-md hover:bg-gray-100">3</button>
          <span className="px-3 py-2 text-gray-500">...</span>
          <button className="px-3 py-2 text-gray-700 hover:text-black rounded-md hover:bg-gray-100">10</button>
          <button className="px-3 py-2 text-gray-700 hover:text-black">Siguiente</button>
        </nav>
      </div>
    </div>
  );
