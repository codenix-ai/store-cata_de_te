...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title =
    siteConfig?.seo?.title || store?.metaTitle || store?.name || "Store";
  const description =
    siteConfig?.seo?.description || store?.metaDescription || "Tienda en línea";
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: brandingName,
        image: `${siteUrl}${
          siteConfig?.hero?.backgroundImage?.id || "/assets/bannercata.webp"
        }`,
      ...
      },
      {
        ...
        mainEntity: {
          ...
          itemListElement: siteConfig?.navigation?.items?.map(
            (item, index) => ({
      ...
      },
      {
        ...
        description:
          ...
          "Catálogo de productos textiles y confección",
  ...
  return (
    <html lang="es">
      <head>
        ...
        <meta
          name="business.contact_data.country"
          content={address?.country || "Colombia"}
        />
        <meta
          name="business.contact_data.region"
          content={address?.state || "Cundinamarca"}
        />
