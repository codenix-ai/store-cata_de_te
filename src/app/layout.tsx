...
export const metadata: Metadata = {
  title: "Tejidos de Punto Colombia | Confección Mayor y Detal | Uniformes y Dotaciones - Pawis S.A.S",
  description:
  ...
  authors: [{ name: "Tejidos de Punto Colombia" }],
  creator: "Tejidos de Punto Colombia",
  publisher: "Tejidos de Punto Colombia",
  ...
  openGraph: {
    ...
    title: "Tejidos de Punto Colombia - Confección Mayor y Detal",
    description: "Empresa líder en tejido de punto. Uniformes, dotaciones y confección textil de alta calidad para empresas y particulares en Colombia.",
    siteName: "Tejidos de Punto Colombia",
    images: [
      {
        url: "/assets/og-image.png",
        width: 1200,
        height: 630,
        alt: "Tejidos de Punto Colombia - Confección textil",
      },
    ],
  },
  twitter: {
    ...
    title: "Tejidos de Punto Colombia - Confección Mayor y Detal",
    description: "Empresa líder en tejido de punto. Uniformes, dotaciones y confección textil de alta calidad.",
    ...
    "@graph": [
      {
        ...
        description: "Empresa líder en tejido de punto y confección textil en Colombia",
        address: {
          "@type": "PostalAddress",
          addressCountry: "CO",
      ...
      },
      {
        ...
        name: "Pawis - Tejidos de Punto Colombia",
        image: "https://pawis.com.co/assets/banner.webp",
        description: "Confección de uniformes, dotaciones y productos textiles al mayor y al detal",
        priceRange: "$$",
      ...
      },
      {
        ...
        url: "https://pawis.com.co",
        name: "Tejidos de Punto Colombia",
        description: "Empresa de confección textil especializada en tejido de punto",
        publisher: {
          "@id": "https://pawis.com.co/#organization",
        },
        potentialAction: [
          {
            ...
            target: {
              "@type": "EntryPoint",
              urlTemplate: "https://pawis.com.co/products?search={search_term_string}",
            },
