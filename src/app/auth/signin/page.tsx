      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            {/* Demo credentials */}
            <div className="mt-6 p-4 rounded-md" style={{ background: store?.primaryColor || '#2563eb' }}>
              <h3 className="text-sm font-medium mb-2" style={{ color: store?.secondaryColor || '#2563eb' }}>
                Credenciales de Demo:
              </h3>
              <p className="text-sm" style={{ color: store?.secondaryColor || '#2563eb' }}>
                Email: demo@emprendyup.com
                <br />
                Contraseña: demo123
              </p>
            </div>
