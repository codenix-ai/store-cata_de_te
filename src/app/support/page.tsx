    ...
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {supportOptions.map((option, index) => (
            ...
            >
              ...
              {option.contact && (
                <p className="font-medium mb-4" style={{ color: store?.primaryColor || '#2563eb' }}>
                  {option.contact}
                </p>
              )}
        ...
        <div
          ...
          style={{
            backgroundColor: store?.primaryColor ? `${store.primaryColor}20` : '#eff6ff',
          }} // 20 = 12% opacity
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <Clock className="w-12 h-12 mx-auto mb-4" style={{ color: store?.primaryColor || '#2563eb' }} />
            ...
            <div className="text-center">
              <MapPin className="w-12 h-12 mx-auto mb-4" style={{ color: store?.primaryColor || '#2563eb' }} />
            ...
            <div className="text-center">
              <Headphones className="w-12 h-12 mx-auto mb-4" style={{ color: store?.primaryColor || '#2563eb' }} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="bg-blue-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="font-semibold" style={{ color: store?.primaryColor || '#2563eb' }}>
                  📋
                </span>
              </div>
            ...
            <div className="text-center">
              <div className="bg-green-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="font-semibold" style={{ color: store?.secondaryColor || '#2563eb' }}>
                  📋
                </span>
              </div>
            ...
            <div className="text-center">
              <div className="bg-orange-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="font-semibold" style={{ color: store?.accentColor || '#2563eb' }}>
                  🔒
                </span>
              </div>
